...
||||||| parent of c3d1bc0 (WIP(client): add reponse processing and start a new thread to listen for multicast)
=======
#include "client.h"
#include "utils.h"
#include "vector.h"
...
void clientCreateClassResponseProcessing(const char *const response) {}
void clientSendResponseProcessing(const char *const response) {}
>>>>>>> c3d1bc0 (WIP(client): add reponse processing and start a new thread to listen for multicast)
